...
import { ArrowRight, Wrench, Settings, Clock, Shield } from 'lucide-react';
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            ...
                            <h3 className="text-xl font-semibold mb-2">Expertiză Tehnică</h3>
                            <p className="text-gray-600">Echipa noastră are expertiza necesară pentru a gestiona orice proiect.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <Settings className="h-12 w-12 text-blue-600 mb-4" />
                            <h3 className="text-xl font-semibold mb-2">Echipamente Moderne</h3>
                            <p className="text-gray-600">Utilizăm tehnologie de ultimă generație pentru rezultate perfecte.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <Clock className="h-12 w-12 text-blue-600 mb-4" />
                            <h3 className="text-xl font-semibold mb-2">Livrare la Timp</h3>
                            <p className="text-gray-600">Respectăm cu strictețe termenele de execuție agreate.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-sm">
                            <Shield className="h-12 w-12 text-blue-600 mb-4" />
                            <h3 className="text-xl font-semibold mb-2">Garanție Extinsă</h3>
                            <p className="text-gray-600">Oferim garanție extinsă pentru toate serviciile noastre.</p>
                        </div>
                    </div>
                </div>
            </div>
